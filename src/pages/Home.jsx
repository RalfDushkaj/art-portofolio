        ...
        <div className='grid grid-cols-3 justify-center items-center lg:grid-cols-3 md:grid-cols-2 max-[800px]:grid-cols-1'>
           {works.map((work) => (
             <div key={work.id} className='p-3 pb5 group'>
               ...
               />
                <p className='text-white text-center text-xl my-3'>{work.name}</p>
             </div>
           ))}
        </div>
        <Link 
          ...
          className=''>
          <p 
           className='text-white text-2xl pt-10 text-center hover:animate-pulse hover:-skew-x-10 hover:duration-500'>
            Go to gallery
          </p>
        </Link>
      </section>
